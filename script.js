...
document
  ...
  .addEventListener("input", function () {
    ...
    document.getElementById("length-req").className = requirements.length
      ? "valid"
      : "invalid";
    document.getElementById("uppercase-req").className = requirements.uppercase
      ? "valid"
      : "invalid";
    document.getElementById("lowercase-req").className = requirements.lowercase
      ? "valid"
      : "invalid";
    document.getElementById("number-req").className = requirements.number
      ? "valid"
      : "invalid";
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  document.getElementById("educationalDetails").value =
